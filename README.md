# Standard Bank Tech Impact Challenge (https://zindi.africa/competitions/sbtic-xente-credit-scoring-challenge)
...
-  indicates that the client defaulted on their loan.
...
- R for data exploration and modeling
